 ...
 * @function setup
 * @param {object} guessedWords - guesssedWords value specific to this setup
 * @returns {ShallowWrapper}
 */
const setup = (guessedWords: Array<IGuessedWordsType> = []): ShallowWrapper => {
